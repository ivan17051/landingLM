...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset('img/lg4.png')}}">
    <link rel="icon" type="image/png" href="{{asset('img/lg4.png')}}">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <br>
          <h3 class="font-weight-bolder text-white mb-0">@yield('title')</h3>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-white font-weight-bold px-0" id="dropdownUser"
                data-bs-toggle="dropdown" aria-expanded="false">
                <i class="fa fa-user me-sm-1"></i>
                <span class="d-sm-inline d-none">Hi, {{auth()->user()->nama}}</span>
              </a>
              <ul class="dropdown-menu  dropdown-menu-end  px-2" style="margin-top:-20px !important;"
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                made with <i class="fa fa-heart"></i> by LEAD ME Team And
